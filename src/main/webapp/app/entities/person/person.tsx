    ...
    return (
      <div>
        <h2 id="person-heading">
          <Translate contentKey="myappdemo05App.person.home.title">People</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="myappdemo05App.person.home.createLabel">Create new Person</Translate>
          </Link>
        </h2>
